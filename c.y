...
%token  enumeration_const   storage_const   type_const      qual_const      struct_const
%token  enum_const          DEFINE          IF              FOR             DO
%token  WHILE               BREAK           SWITCH          CONTINUE        RETURN
%token  CASE                DEFAULT         GOTO            SIZEOF          PUNC
%token  or_const            and_const       eq_const        shift_const     rel_const
%token  inc_const           point_const     param_const     ELSE            HEADER
...
decl_specs:
        storage_const decl_specs
		| storage_const
		| type_spec decl_specs								
		| type_spec 										
		| qual_const decl_specs
		| qual_const
		;
...
spec_qualifier_list:
		...
		| type_spec
		| qual_const spec_qualifier_list
		| qual_const
		;
...
type_qualifier_list:
        qual_const
		| type_qualifier_list qual_const
		;
